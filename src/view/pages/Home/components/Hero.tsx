...
export const Hero: FC = () => {
  ...
  return (
    <>
      ...
      > */}
      <header className='w-full h-screen relative overflow-hidden backdrop-blur-3xl'>
        <div className=' flex h-full flex-col items-center justify-center'>
          <div
            ...
            className='flex flex-col items-center text-6xl font-semibold md:text-8xl uppercase tracking-tighter  text-tron-beige'
          >
            <h6 className='text-sm uppercase tracking-wider m-2 text-tron-primary font-bold'>
              Bernardo Moschen
            </h6>
            <div>Empowering</div>
            <div className='text-tron-amber font-Protest font-medium'>
              dreams
            </div>
            <div>since</div>
            <div>2020</div>
